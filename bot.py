...
def consultar_gemini(prompt_usuario):
    ...
    try:
        logger.info("Generando contenido con gemini-1.5-flash...")
        ...
        logger.error(f"Error detallado con la API de Gemini: {e}")
        return f"⚠️ Error con Gemini: {str(e)[:100]}"

    return "⚠️ Error temporal generando la respuesta."
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 2. Obtener el mensaje de forma segura (evita errores si update.message es None)
